...
<template>
  <div>
    <p>el-collapse 和el-collapse-item</p>
    <p>el-collapse里v-model绑定数据</p>
    <p>el-collapse-item里title为标题，name与v-model呼应</p>
    ...
    <p>想要实现手风琴效果只需要在el-collapse里加个accordion就行</p>
    <p>想自定义标题，可以template #title 实现</p>
  </div>
</template>
