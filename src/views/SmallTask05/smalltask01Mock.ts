...
const teachers: Teacher[] = [
  { id: 'teacher1', name: '张锡英', departmentId: '1' },
  { id: 'teacher2', name: '王波', departmentId: '1' },
  { id: 'teacher3', name: '李莉', departmentId: '2' },
  { id: 'teacher4', name: '边继龙', departmentId: '2' },
  { id: 'teacher5', name: '单颖', departmentId: '3' },
  { id: 'teacher6', name: '谷志新', departmentId: '3' }
]
