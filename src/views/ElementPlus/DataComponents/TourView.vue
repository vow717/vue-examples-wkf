...
<template>
  <div>
    <p>Tour漫游式引导，分布引导用户了解功能的气泡组件</p>
    <p>
      el-tour v-model=""绑定个响应式数据，弄个开始引导的按钮，把这个数据改成true然后就可以开始引导
    </p>
    <p>
      el-tour-step,引导的一个步骤，:target="ref1?.$el"指定目标元素为ref1所引用按钮的底层DOM元素，Title="设置标题"，description描述
    </p>
